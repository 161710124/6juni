...
<body>
	...
	<div id="body">
		<div id="featured"> <a href="index.html"><img src="/assets/user/images/tam.jpg" width="974" height="614" alt=""> </a>
			<ul>
				<li class="first">
				...
				<li>
					<a href="index.html"><img src="/assets/user/images/discount.png" width="75" height="62" alt=""></a>
					<h1>FREE WI-FI</h1>
				</li>
				<li class="last">
					
					<p>
						KEPUASANMU KEPUASANKU , KENYAMANANMU TANGGUNG JAWABKU
					</p>
				</li>
			</ul>
		</div>
	...
	<div id="footer">
		<div>
					...
					<div>
						<ul>
							<li class="first">
								<h2>Blog</h2>
								<p>
									Keamanan , Kenyamanan & Kepuasan Yang Kami Utamakan <a href="blog.html" class="readmore">(more)</a>
								</p>
							</li>
							<li>
								<h2>get in touch</h2>
			...
			<div class="footnote">
				<p>
					&copy; Copyright 2018. Muhammad Fidly Alfirdaus.
				</p>
			</div>
		</div>
	</div>
